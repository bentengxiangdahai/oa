...
<body>
<form action="adddepartment" target="frmright" method="post">
		<table class="tableStyle" transMode="true">
		<tr>
			<td>部门名称：</td><td><input type="text" name="departmentname"/>
				<input type="hidden" name="parentId" value="${parentId }">
			</td>
		</tr>
		<tr>
			<td>部门电话：</td><td><input type="text" name="departmenttel"/></td>
		</tr>
		<tr>
			<td colspan="2">
