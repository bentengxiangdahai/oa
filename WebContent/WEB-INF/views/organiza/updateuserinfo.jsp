...
<body>
<form action="updateuser" target="frmright" method="post">
		<table class="tableStyle" transMode="true">
		<tr>
			<td>用户姓名：</td><td><input type="text" name="username" value="${USER.username }"/>
				<input type="hidden" name="departmentId" value="${USER.departmentId }">
				<input type="hidden" name="userId" value="${USER.userId }">
			</td>
		</tr>
		<tr>
			<td>用户邮箱：</td><td><input type="text" class=" validate[required,custom[email]]" name="email" value="${USER.email }"/><span class="star">*</span></td>
		</tr>
		<tr>
			<td>用户密码：</td><td><input type="text" class=" validate[required]" name="password" value="${USER.password }"/><span class="star">*</span></td>
		</tr>
		<tr>
			<td>用户电话：</td><td><input type="text" name="tel" value="${USER.tel }"/></td>
		</tr>
		<tr>
			<td>用户生日：</td><td><input type="text" class="date" name="birthday" value="${USER.birthday }"/></td>
		</tr>
		<tr>
			<td>用户学历：</td><td>
				<select name="xueli">
