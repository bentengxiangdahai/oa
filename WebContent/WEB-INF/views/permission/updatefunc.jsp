...
<body>
<form action="updatefunc" target="frmright" method="post">
		<table class="tableStyle" transMode="true">
		<tr>
			<td>功能点名称：</td><td><input type="text" name="functionname" value="${func.functionname }"/>
				<input type="hidden" name="parentId" value="${func.parentId }">
				<input type="hidden" name="functionId" value="${func.functionId }">
			</td>
		</tr>
		<tr>
			<td>功能点URL：</td><td><input type="text" name="url" value="${func.url }"/></td>
		</tr>
		<tr>
			<td colspan="2">
