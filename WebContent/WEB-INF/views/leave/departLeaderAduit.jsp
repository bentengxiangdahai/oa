...
<body>
<form action="completeleavedepart" target="frmright" method="post">
		...
		<tr>
			<td>选择：</td>
			<td>
				<input type="radio" name="departLeader" value="1" checked>同意
				<input type="radio" name="departLeader" value="0">不同意
			</td>
		</tr>
		<tr>
			<td>
