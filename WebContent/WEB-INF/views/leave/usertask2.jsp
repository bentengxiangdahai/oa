...
<body>
<form action="completeleaveusertask2" target="frmright" method="post">
		<table class="tableStyle" transMode="true">
		<tr>
			<td>请假类型：</td>
			<td>
				<input type="text" name="leavetype" value="${leave.leavetype }">
		...
		<tr>
			<td>开始时间：</td>
			<td>
				<input type="text" name="leavestarttime" class="date" value="${leave.leavestarttime }"/>
			</td>
		</tr>
		<tr>
			<td>结束时间：</td>
			<td>
				<input type="text" name="leaveendtime" class="date" value="${leave.leaveendtime }"/>
			</td>
		</tr>
		<tr>
			<td>请假天数：</td>
			<td>
				<input type="text" name="leaveday" value="${leave.leaveday }"/>
			</td>
		</tr>
		<tr>
			<td>原因：</td>
			<td>
				<textarea rows="10" cols="20" name="reason">${leave.reason }</textarea>
			</td>
		</tr>
		<tr>
			<td>
